...
public struct PodcastMinified: Codable {
    ...
    public init(libraryItemID: String? = nil, metadata: PodcastMetadata? = nil, coverPath: String? = nil, tags: [String]? = nil, numEpisodes: Int? = nil, isAutoDownloadEpisodes: Bool? = nil, autoDownloadSchedule: String? = nil, lastEpisodeCheck: Int? = nil, maxEpisodesToKeep: Int? = nil, maxNewEpisodesToDownload: Int? = nil, size: Int? = nil) {
