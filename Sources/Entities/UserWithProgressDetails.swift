...
public struct UserWithProgressDetails: Codable {
    ...
    public var mediaProgress: [MediaProgressWithMedia]?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.mediaProgress = try values.decodeIfPresent([MediaProgressWithMedia].self, forKey: "mediaProgress")
