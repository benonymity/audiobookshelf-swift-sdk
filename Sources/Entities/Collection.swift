...
public struct Collection: Codable {
    ...
    public init(id: String? = nil, libraryID: String? = nil, userID: String? = nil, name: String? = nil, description: String? = nil, books: [LibraryItem]? = nil, lastUpdate: Int? = nil, createdAt: Int? = nil) {
        self.id = id
