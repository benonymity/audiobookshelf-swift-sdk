...
public struct Podcast: Codable {
    ...
    public init(libraryItemID: String? = nil, metadata: PodcastMetadata? = nil, coverPath: String? = nil, tags: [String]? = nil, episodes: [PodcastEpisode]? = nil, isAutoDownloadEpisodes: Bool? = nil, autoDownloadSchedule: String? = nil, lastEpisodeCheck: Int? = nil, maxEpisodesToKeep: Int? = nil, maxNewEpisodesToDownload: Int? = nil) {
